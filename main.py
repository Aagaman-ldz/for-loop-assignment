...
# choice = input("Do you want vegeterian or non vegeterian? ")
# if choice.lower()=="vegeterian":
#     dish = input("Do you want Salad or Pasta? ")
# elif choice.lower()=="non vegeterian":
#     input("Do you want Chicken or Fish? ")
# else:
#     print('Please enter a valid choice, "vegeterian" for veg and "non vegeterian" for non veg')
...
#     choice2 = input("Explore or Rest? ")
#     if choice2.lower() == "explore":
